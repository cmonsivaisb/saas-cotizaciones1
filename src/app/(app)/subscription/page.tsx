  ...
  return (
    <div className="space-y-6">
      ...
      <div className="flex items-center justify-between">
        <div>
          <h1 className="text-3xl font-bold tracking-tight text-primary-900">Suscripción</h1>
          <p className="text-primary-500 mt-1">
            Gestiona tu suscripción al sistema CotizaNet
          </p>
        </div>
      ...
      <Card>
        <CardHeader>
          ...
          <CardDescription>
            Historial de facturas de tu suscripción a CotizaNet
          </CardDescription>
        </CardHeader>
        <CardContent>
